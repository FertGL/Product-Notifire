package ru.fertgl.emailnotification.config;
...
import ru.fertgl.emailnotification.exception.NonRetryableException;
import ru.fertgl.emailnotification.exception.RetryableException;
...
public class KafkaConfig {
    ...
    ProducerFactory<String, Object> producerFactory() {
        ...
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, environment.getProperty("spring.kafka.consumer.bootstrap-server"));
